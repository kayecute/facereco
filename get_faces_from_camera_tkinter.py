...
class Face_Register:
    def __init__(self):
        ...
        self.cap = cv2.VideoCapture(1)  # Get video stream from extends camera
    ...
    def create_face_folder(self):
        # sCreate the folders for saving faces
    ...
    #         # Chuyển frame sang định dạng RGB để sử dụng với dlib
    #         rgb_frame = cv2.cvtColor(self.current_frame, cv2.COLOR_BGR2RGB)
            
    #         # Sử dụng HOG detector để phát hiện khuôn mặt trên frame
    #         detector = dlib.get_frontal_face_detector()
    ...
    #             cv2.rectangle(self.current_frame, (x, y), (x+w, y+h), (255, 255, 255), 2)
